...
const products = [
  {
    ...
    tag: "For B2B brands",
    body: "A revolutionary way to bridge the gap between sales and marketing. In B2B, if your foundations are misaligned, the odds are stacked against you — Foundations First gets the plumbing right so growth has somewhere to land.",
      ...
      <div className="container-r17 py-20 md:py-24">
        <div className="grid grid-cols-12 items-end gap-y-6">
          <Reveal className="col-span-12 md:col-span-8">
            <p className="eyebrow text-white/70">[ 07 ] Products</p>
            <h2 className="mt-5 font-display text-3xl font-semibold leading-[1.1] tracking-tight md:text-5xl">
              Services are our core.{" "}
              <span className="serif-accent text-white/80">These are the products we've built on top.</span>
            </h2>
          </Reveal>
          <Reveal delay={0.1} className="col-span-12 md:col-span-4">
            <p className="text-[14px] leading-relaxed text-white/85">
              Three productised programmes, each born from a real client need —
              for founders too small for an agency, for B2B teams with broken
              foundations, and for Swiss e‑commerce brands who want to land in
